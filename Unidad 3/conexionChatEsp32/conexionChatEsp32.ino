...
// MQTT Broker
const char *mqtt_broker = "v3e23249.ala.us-east-1.emqxsl.com";   // broker address
const char *topic = "test";      // define topic
const char *mqtt_username = "Jisoo"; // username for authentication
const char *mqtt_password = "BlackPink"; // password for authentication
